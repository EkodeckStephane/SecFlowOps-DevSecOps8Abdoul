...
\centering
\includegraphics[width=0.92\linewidth]{../figures/pipeline_success_by_config_full_protocol.png}
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=0.92\linewidth]{../figures/coverage_precision_recall_full_protocol.png}
\end{minipage}
