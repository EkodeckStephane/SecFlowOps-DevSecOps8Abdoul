...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{../figures/performance_overheads_full_protocol.png}
\caption{Full-protocol performance overheads generated from the processed timing metrics.}
\label{fig:performance-overheads}
\end{figure}
